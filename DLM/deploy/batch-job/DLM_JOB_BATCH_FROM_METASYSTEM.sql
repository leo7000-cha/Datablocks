...
--
--   #{JOBID}          -> 잡 ID                            (기본값: DLM_BATCH_METASYSTEM)
--   #{SOURCE_DB}      -> 원천 DB명 (메타시스템 접속 DB)    (예: DAON)
--   #{HOME_DB}        -> DLM Home DB명                    (기본값: DLM)
--   #{DLM_SCHEMA}     -> DLM 스키마명                     (기본값: COTDL)
--   #{BATCH_TIME}     -> 실행 시각 (HH:MM)                (기본값: 00:10)
...
INSERT INTO #{DLM_SCHEMA}.TBL_PIIJOB (
    ...
    '#{JOBID}', '1', '#{JOBID}_DATA_수집', NULL, NULL, NULL,
...
INSERT INTO #{DLM_SCHEMA}.TBL_PIISTEP (
    ...
    '#{JOBID}', '1', 'EXTRACT_METASYSTEM', 'METASYSTEM 정보 추출', 'EXE_EXTRACT', 1, '#{SOURCE_DB}',
...
INSERT INTO #{DLM_SCHEMA}.TBL_PIISTEP (
    ...
    '#{JOBID}', '1', 'EXE_HOMECAST', 'METASYSTEM HOMECAST', 'EXE_HOMECAST', 2, '#{SOURCE_DB}',
...
INSERT INTO #{DLM_SCHEMA}.TBL_PIISTEPTABLE (
    ...
    '#{JOBID}', '1', 'EXTRACT_METASYSTEM', '#{SOURCE_DB}', '#{DLM_SCHEMA}', 'TBL_PIITABLE',
    NULL, 'ADD', 'EXTRACT', '', '', NULL, NULL,
    10, 100, 10, NULL,
    '기존 추출 METASYSTEM 정보 제거', '', '', NULL, NULL,
    NULL, 'DELETE FROM #{DLM_SCHEMA}.TBL_METASYSTEMDATA',
    NULL, NULL, NULL, '', NULL,
...
INSERT INTO #{DLM_SCHEMA}.TBL_PIISTEPTABLE (
    ...
    '#{JOBID}', '1', 'EXTRACT_METASYSTEM', '#{HOME_DB}', '#{DLM_SCHEMA}', 'TBL_PIITABLE',
    NULL, 'ADD', 'EXTRACT', '', '', NULL, NULL,
    10, 200, 10, NULL,
    '기존 추출 METASYSTEM 정보 제거', '', '', NULL, NULL,
    NULL, 'DELETE FROM #{DLM_SCHEMA}.TBL_METASYSTEMDATA',
...
INSERT INTO #{DLM_SCHEMA}.TBL_PIISTEPTABLE (
    ...
    NULL,
'INSERT INTO #{DLM_SCHEMA}.TBL_METASYSTEMDATA
...
INSERT INTO #{DLM_SCHEMA}.TBL_PIISTEPTABLE (
    ...
    '#{JOBID}', '1', 'EXE_HOMECAST', '#{HOME_DB}', '#{DLM_SCHEMA}', 'TBL_METASYSTEMDATA',
    NULL, NULL, 'HOMECAST', '', '', NULL, NULL,
    10, 100, 10, NULL,
    '', '', '', NULL, NULL,
    ' ',
'INSERT INTO #{DLM_SCHEMA}.TBL_METASYSTEMDATA -- DB in Step
SELECT * FROM #{DLM_SCHEMA}.TBL_METASYSTEMDATA -- Source DB : #{SOURCE_DB}',
    NULL, NULL, NULL, '', NULL,
    NOW(), NOW(), '#{ADMIN_USER}', '#{ADMIN_USER}'
);
