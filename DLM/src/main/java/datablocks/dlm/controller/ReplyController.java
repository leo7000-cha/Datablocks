...
import datablocks.dlm.service.ReplyService;
...
public class ReplyController {
    ...
    public ResponseEntity<String> create(@RequestBody ReplyVO vo) {
        LogUtil.log("INFO", "ReplyVO: " + vo);
        int insertCount = service.register(vo);
        LogUtil.log("INFO", "Reply INSERT COUNT: " + insertCount);
    ...
    public ResponseEntity<String> remove(@RequestBody ReplyVO vo, @PathVariable("rno") Long rno) {
        LogUtil.log("INFO", "remove: " + rno);
        LogUtil.log("INFO", "replyer: " + vo.getReplyer());
    ...
    public ResponseEntity<ReplyPageDTO> getList(@PathVariable("page") int page, @PathVariable("bno") Long bno) {
        Criteria cri = new Criteria(page, 10);
        LogUtil.log("INFO", "get Reply List bno: " + bno);
        LogUtil.log("INFO", "cri:" + cri);
