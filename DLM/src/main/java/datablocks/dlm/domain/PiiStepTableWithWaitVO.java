...
@Data
public class PiiStepTableWithWaitVO {
	...
	/*waiting update */
	private String db_w;//waiting table info
	private String owner_w;//waiting table info
	private String table_name_w;//waiting table info
	private String updates;//for update col information
