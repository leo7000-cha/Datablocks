            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form style="margin: 0; padding: 0;" role="form" id="piiapprovaluser_get_form" method="post">
                            <table class="m-1" style="border-collapse: collapse; border: 1px; width: 40.7%">
                                ...
                                <tr>
                                    <th class="th-get"><spring:message code="col.approvalid" text="Approvalid"/></th>
                                    <td class="td-get-l"><c:out value="${piiapprovaluser.approvalid}"/><input
                                            type="hidden" class="form-control form-control-sm" name='approvalid'
                                            value='<c:out value="${piiapprovaluser.approvalid}"/>'></td>
                                </tr>
                                <tr>
                                    <th class="th-get"><spring:message code="col.approvalname"
                                                                       text="Approvalname"/></th>
                                    <td class="td-get-l"><c:out value="${piiapprovaluser.approvalname}"/><input
                                            type="hidden" class="form-control form-control-sm" name='approvalname'
                                            value='<c:out value="${piiapprovaluser.approvalname}"/>'></td>
                                </tr>
                                <tr>
                                    <th class="th-get"><spring:message code="col.approverid" text="Approverid"/></th>
                                    <td class="td-get-l"><c:out value="${piiapprovaluser.approverid}"/><input
                                            type="hidden" class="form-control form-control-sm" name='approverid'
                                            value='<c:out value="${piiapprovaluser.approverid}"/>'></td>
                                </tr>
                                <tr>
                                    <th class="th-get"><spring:message code="col.approvername"
                                                                       text="Approvername"/></th>
                                    <td class="td-get-l"><c:out value="${piiapprovaluser.approvername}"/><input
                                            type="hidden" class="form-control form-control-sm" name='approvername'
                                            value='<c:out value="${piiapprovaluser.approvername}"/>'></td>
                                </tr>
...
<script type="text/javascript">
    $(function () {
        $("#menupath").html(Menupath + '<i class="fas fa-chevron-right" style="font-size: 18px; margin: 0 6px; color: #888;"></i>' + "<spring:message code="memu.piiapprovaluser_management" text="Approvaline mgmt"/>" + ">Details");
    });
    $(document).ready(function () {
        ...
        $("button[data-oper='modify']").on("click", function (e) {
            ...
            var serchkeyno1 = $('#piiapprovaluser_get_form [name="approvalid"]').val();
            var serchkeyno2 = $('#piiapprovaluser_get_form [name="approverid"]').val();
            url_view = "modify?approvalid=" + serchkeyno1 + "&" + "approverid=" + serchkeyno2
                + "&";
