            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form style="margin: 0; padding: 0;" role="form" id="piiapprovaluser_register_form" action="/piiapprovaluser/register"
                              method="post">
                            <table class="m-1" style="border-collapse: collapse; border: 1px; width: 60.7%">
                                <colgroup>
                                    <col style="width: 20%"/>
                                    <col style="width: 80%"/>
                                </colgroup>
                                ...
                                <tr>
                                    ...
                                    <td class="td-get-l">
                                        <select class="pt-0 pb-0 form-control form-control-sm" name="approvalid"
                                                style="height:25px">
                                            <c:forEach items="${Approvallist}" var="approval">
                                                <c:if test='${approval.approvalid eq "RESTORE_APPROVAL"}'>
                                                    <option value="<c:out value="${approval.approvalid}"/>">
                                                        <c:out value="${approval.approvalid}"/> [<c:out
                                        ...
                                        <c:forEach items="${Approvallist}" var="approval">
                                            <c:if test='${approval.approvalid eq "RESTORE_APPROVAL"}'>
                                                <input type="hidden" class="form-control form-control-sm"
                                                       name='approvalname'
                                                       value='<c:out value="${approval.approvalname}"/>'>
                                            </c:if>
                                        </c:forEach>
                            ...
                            <input type="hidden" class="form-control form-control-sm" name='seq' value='1'>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#piiapprovaluser_register_form [name="approvalid"]').bind("keyup", function () {
            $(this).val($(this).val().toUpperCase());
        });
        $("button[data-oper='register']").on("click", function (e) {

            var formsubmitSerialArray = $("#piiapprovaluser_register_form").serializeArray();
