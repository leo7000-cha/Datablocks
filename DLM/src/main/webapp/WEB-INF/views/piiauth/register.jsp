            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form style="margin: 0; padding: 0;" role="form" id="piiauth_register_form" action="/piiauth/register" method="post">
                            <table class="m-1" style="border-collapse: collapse; border: 1px; width: 40.7%">
                                ...
                                <tr>
                                    ...
                                    <td class="td-get-l">
                                        <input type="text" class="form-control form-control-sm" autofocus name='userid'
                                ...
                                <tr>
                                    ...
                                    <td class="td-get-l">
                                        <%-- <input type="text" class="form-control form-control-sm" name='auth' value='<c:out value="${piiauth.auth}"/>'> --%>
                                        <select class="pt-0 pb-0 form-control form-control-sm" name="auth" style="height:27px;">
...
<script type="text/javascript">
    $(function () {
        $("#menupath").html(Menupath + '<i class="fas fa-chevron-right" style="font-size: 18px; margin: 0 6px; color: #888;"></i>' + "<spring:message code="memu.auth_management" text="Auth management"/>" + ">Register");
    });
    $(document).ready(function () {
        ...
        $("button[data-oper='register']").on("click", function (e) {
            ...
            var elementForm = $("#piiauth_register_form");
            var elementResult = $("#content_home"); //alert($('#piiauth_register_form [name="db"]').val());
            ingShow(); $.ajax({
                type: "POST",
