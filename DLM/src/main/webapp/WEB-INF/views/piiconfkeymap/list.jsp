            ...
            <div class="search-container">
                <div class="search-item">
                    <div class="form-group row">
                        <label class="lable-search col-sm-4"
                               style="vertical-align: middle;" for="keymap_id">Keytype</label>
                        <div class="col-sm-7">
                            <input type=text class="form-control form-control-sm"
                                   style="height: 25px; vertical-align: middle" id="keymap_id"
                                   name="keymap_id"
                ...
                <div class="search-item">
                    <div class="form-group row">
                        <label class="lable-search col-sm-4"
                               style="vertical-align: middle;" for="keyname">Keyname</label>
                        <div class="col-sm-7">
                            <input type=text class="form-control form-control-sm"
                                   style="height: 25px; vertical-align: middle" id="keyname"
                                   name="key_name"
                                   onkeypress="if (event.keyCode === 13) {event.preventDefault();searchAction(1);}"
                ...
                <div class="search-item">
                    <div class="form-group row">
                        <label class="lable-search col-sm-4"
                               style="vertical-align: middle;" for="keycolumns">Keycolumns</label>
                        <div class="col-sm-7">
                            <input type=text class="form-control form-control-sm"
                                   style="height: 25px; vertical-align: middle" id="keycolumns"
                                   name="keycolumns"
                                   onkeypress="if (event.keyCode === 13) {event.preventDefault();searchAction(1);}"
    ...
    <div class="card-body m-1 p-0">
        <div class="tableWrapper">
            <table id="listTable" class="table table-sm table-hover">
                ...
                <tbody>
                <c:forEach items="${list}" var="piiconfkeymap">
                    <tr>
                        <td class="td-get"><c:out value="${piiconfkeymap.keymap_id}"/></td>
                        <td class="td-get"><c:out value="${piiconfkeymap.key_name}"/></td>
                        <td class="td-get"><c:out value="${piiconfkeymap.db}"/></td>
                        <td class="td-get"><c:out value="${piiconfkeymap.seq1}"/></td>
                        <td class="td-get"><c:out value="${piiconfkeymap.seq2}"/></td>
                        <td class="td-get"><c:out value="${piiconfkeymap.seq3}"/></td>
                            <%-- <td class="td-get"><c:out value="${piiconfkeymap.key_cols}"/></td> --%>
                        <td class="td-get"><c:out value="${piiconfkeymap.src_owner}"/></td>
                        <td class="td-get"><c:out value="${piiconfkeymap.src_table_name}"/></td>
                        <td class="td-get"><c:out value="${piiconfkeymap.where_col}"/></td>
                        <td class="td-get"><c:out value="${piiconfkeymap.where_key_name}"/></td>
                        <td class="td-get"><c:out value="${piiconfkeymap.status}"/></td>
                        <td class="td-get"><c:out value="${piiconfkeymap.sqltype}"/></td>
                            <%-- 	<td class="td-get"><c:out value="${piiconfkeymap.insertstr}"/></td>
                                <td class="td-get"><c:out value="${piiconfkeymap.wherestr}"/></td>
                                <td class="td-get"><c:out value="${piiconfkeymap.refstr}"/></td> --%>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
...
<script type="text/javascript">
    ...
    $(function () {
        $("#menupath").html(Menupath + ">ConfKeymap mamagement");
    });
    $(function () {
        $("#menupath").html(Menupath + '<i class="fas fa-chevron-right" style="font-size: 18px; margin: 0 6px; color: #888;"></i>' + "<spring:message code="memu.keymap" text="ConfKeymap management"/>");
    });
    $(document).ready(function () {
        ...
        $('#listTable tbody').on('dblclick', 'tr', function (e) {
            ...
            var serchkeyno6 = td.eq(5).text().trim();

            var serchkeyno = "keymap_id=" + serchkeyno1
            ...
            //$('#content_home').load("/piiconfkeymap/get?piikeyno="+no+"&pagenum=${pageMaker.cri.pagenum}&amount=${pageMaker.cri.amount}");
        ...
        $("button[data-oper='register']").on("click", function (e) {
            e.preventDefault();e.stopPropagation();
            $('#content_home').load("/piiconfkeymap/register");
        })
    ...
    movePage = function (pageNo) {
        ...
        /* 	alert("/piiconfkeymap/"+url_view+"pagenum="+pagenum+"&amount="+amount+url_search);
            $('#content_home').load("/piiconfkeymap/"+url_view+"pagenum="+pagenum+"&amount="+amount+url_search); */
    }
    ...
    searchAction = function (pageNo, serchkeyno) {
        ...
        var url_search = "";
        var url_view = "";
        //alert("pagenum:" + pagenum + "amount:" + amount + "key_name:" + key_name + "key_cols:" + key_cols);
