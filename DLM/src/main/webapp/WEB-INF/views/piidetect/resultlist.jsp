        ...
        <form style="margin: 0; padding: 0;" role="form" id=searchForm>
            ...
            <div class="search-container-4-same">
                <div class="search-item">
                    <div class="form-group row">
                        <label class="lable-search col-sm-3" style="vertical-align: middle;"
                               for="search1"><spring:message code="col.db" text="DB"/></label>
                        <div class="col-sm-8">
                ...
                <div class="search-item">
                    <div class="form-group row">
                        <label class="lable-search col-sm-3" style="vertical-align: middle;"
                               for="search2"><spring:message code="col.owner" text="OWNER"/></label>
                        <div class="col-sm-8">
                            <input type=text class="form-control form-control-sm"
                ...
                <div class="search-item">
                    <div class="form-group row">
                        <label class="lable-search col-sm-3" style="vertical-align: middle;"
                               for="search3"><spring:message code="col.table_name" text="TABLE"/></label>
                        <div class="col-sm-8">
                            <input type=text class="form-control form-control-sm"
                                   style="height: 25px; vertical-align: middle" id="search3"
                                   name="search3"
                                   onkeypress="if (event.keyCode === 13) {event.preventDefault();searchAction(1);}"
        ...
        <div class="tableWrapper" >
            <table id="listTable" class="table table-sm table-hover">
                ...
                <tr>
                    ...
                    <th scope="row" class="th-get"><spring:message code="col.orderid" text="Orderid" /></th>
                    <th scope="row" class="th-get"><spring:message code="col.piitype" text="PiiCnt" /></th>
                    <th scope="row" class="th-get"><spring:message code="col.piicnt" text="PiiCnt" /></th>
                    <th scope="row" class="th-get"><spring:message code="col.detect_all_cnt" text="Detect_All_Cnt" /></th>
                    <th scope="row" class="th-get"><spring:message code="col.pii_ratio" text="Pii_Ratio" /></th>
                    <th scope="row" class="th-get"><spring:message code="col.detect_date" text="Detect_date" /></th>
                    <%--<th scope="row" class="th-get"><spring:message code="col.sampledata" text="Sampledata" /></th>--%>
                </tr>
                </thead>
                <tbody>
                <c:forEach items="${list}" var="piidetect_result">
                        <tr>
                            <td class="td-get"><c:out value="${piidetect_result.db}" /></td>
                            <td class="td-get"><c:out value="${piidetect_result.owner}" /></td>
                            <td class="td-get-l"><c:out value="${piidetect_result.table_name}" /></td>
                            <td class="td-get"><c:out value="${piidetect_result.column_name}" /></td>
                            <td class="td-get"><c:out value="${piidetect_result.orderid}" /></td>
                            <td class="td-get"><c:out value="${piidetect_result.piitype}" /></td>
                            <td class="td-get-r"><c:out value="${piidetect_result.piicnt}" /></td>
                            <td class="td-get-r"><c:out value="${piidetect_result.detect_all_cnt}" /></td>
                            <td class="td-get-r"><c:out value="${piidetect_result.pii_ratio}" />%</td>
                            <td class="td-get"><c:out value="${piidetect_result.regdate}" /></td>
                            <%--<td><c:out value="${piidetect_result.sampledata}" /></td>--%>
                        </tr>
                </c:forEach>
                </tbody>
            </table>
...
<script type="text/javascript">
    ...
    $(function () {
        $("#menupath").html(Menupath + '<i class="fas fa-chevron-right" style="font-size: 18px; margin: 0 6px; color: #888;"></i>' + "<spring:message code="memu.detect_result_list" text="Detect_result"/>" + "");
    });
