...
<div class="row mt-3 mb-3 ml-1 mr-1 ">
    <div class="col-sm-12">
        <div class="panel panel-default" style="height: 540px;width: 100%">
                ...
                <form style="margin: 0; padding: 0;" role="form" id="piisteptable_modify_form">
                    ...
                    <table class="m-0" style="width: 100%">
                        ...
                        <c:choose>
                            <c:when test="${exetype eq 'EXTRACT'}">
                                <tr>
                                    ...
                                    <td class="td-get-l">
                                        <select class="pt-0 pb-0 form-control form-control-sm" name="pagitypedetail"
                                                style="height:27px;">
                                            <option value="ADD"
                                                    <c:if test="${piiordersteptable.pagitypedetail eq 'ADD'}">selected</c:if> >
                                                추가
                                            </option>
                                            <option value="EXCLUDE"
                                                    <c:if test="${piiordersteptable.pagitypedetail eq 'EXCLUDE'}">selected</c:if> >
                                                제외
                                            </option>
                                            <option value="ETC"
                                                    <c:if test="${piiordersteptable.pagitypedetail eq 'ETC'}">selected</c:if> >
                                                기타
                                            </option>
                                        </select>
                                    </td>
                                    <th class="th-get">Task Name</th>
                                    <td class="td-get-l" colspan=3><input type="text"
                            ...
                            <c:when test="${exetype eq 'KEYMAP'}">
                                <tr>
                                    ...
                                    <td class="td-get-l"><c:out value="${piisteptable.keymap_id}"/></td>
                        ...
                        <tr>
                            <c:choose>
                                ...
                                <c:when test="${exetype eq 'KEYMAP'}">
                                    ...
                                    <td class="td-get-l">
                                        <c:choose>
                                            <c:when test="${piisteptable.sqltype eq 'AUTO' }">AUTO</c:when>
                                            <c:when test="${piisteptable.sqltype eq 'AUTOMANAUL' }">AUTO+MANAUL</c:when>
                                            <c:when test="${piisteptable.sqltype eq 'MANUAL' }">MANUAL</c:when>
                                            <c:otherwise> <c:out value="${piisteptable.sqltype}"/> </c:otherwise>
                                        </c:choose>
                                    </td>
                                </c:when>
                                <c:otherwise>
                        ...
                        <tr>
                            ...
                            <td class="td-get-l">
                                <select style="height:27px;" class="pt-0 pb-0 form-control form-control-sm"
                                        name="status">

                                    <option value="Wait condition"
                                            <c:if test="${piiordersteptable.status eq 'Wait condition'}">selected</c:if> >
                                        Wait
                                    </option>
                                    <option value="Ended OK"
                                            <c:if test="${piiordersteptable.status eq 'Ended OK'}">selected</c:if> >
                                        Ended OK
                                    </option>
                                    <option value="Ended not OK"
                                            <c:if test="${piiordersteptable.status eq 'Ended not OK'}">selected</c:if> >
                                        Error
                                    </option>
                                    <option value="Running"
                                            <c:if test="${piiordersteptable.status eq 'Running'}">selected</c:if> >
                                        Running
                                    </option>
                                    <option value="Recovered"
                                            <c:if test="${piiordersteptable.status eq 'Recovered'}">selected</c:if> >
                                        Recovered
                                    </option>
                                    <option value="Hold"
                                            <c:if test="${piiordersteptable.status eq 'Hold'}">selected</c:if> >Hold
                                    </option>
                                </select>
                            </td>
                        </tr>
                                ...
                                <c:when test="${exetype eq 'ARCHIVE'}">
                                    ...
                                    <td class="td-get-l">
                                        <c:choose>
                                            ...
                                            <c:otherwise> <input type="text" class="form-control form-control-sm"
                                                                 name='pagitypedetail'
                                                                 value='<c:out value="${piiordersteptable.pagitypedetail}"/>'>
                                            </c:otherwise>
                                        </c:choose>
                                    ...
                                    <c:choose>
                                        ...
                                        <c:when test="${exetype eq 'HOMECAST'}">
                                            ...
                                            <td class="td-get-l"><input type="text" class="form-control form-control-sm"
                                                                        ...
                                                                        onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"
                                                                        name='commitcnt'
                                                                        value='<c:out value="${piiordersteptable.commitcnt}"/>'>
                                            </td>
                                        </c:when>
                                        <c:when test="${exetype eq 'SCRAMBLE' or exetype eq 'MIGRATE'}">
                                            ...
                                            <%--<th class="th-get"><spring:message code="col.sqltype" text="Sql type"/></th>
                                            <td class="td-get-l">
                                                <select class="form-control form-control-sm" name="sqltype" id="sqlTypeSelect">
                                                    <option value="MANUAL"
                                                            <c:if test="${piiordersteptable.sqltype eq 'MANUAL'}">selected</c:if> >Where문 직접 입력
                                                    </option>
                                                    <option value="AUTO"
                                                            <c:if test="${piiordersteptable.sqltype eq 'AUTO'}">selected</c:if> >Keymap Wizard
                                                    </option>
                                                </select>
                                            </td>--%>

                                            <%--<td class="td-get-l" COLSPAN="2">
                                                <button id="wizardButton" data-oper="wizard_steptable_modify" class="btn btn-info btn-sm p-0 pb-2 button"
                                                        style="<c:if test="${piiordersteptable.sqltype eq 'AUTO'}">display: block;</c:if><c:if test="${piiordersteptable.sqltype ne 'AUTO'}">display: none;</c:if>">
                        ...
                        <c:choose>
                            <c:when test="${exetype eq 'KEYMAP' || exetype eq 'ARCHIVE' || exetype eq 'FINISH' || exetype eq 'TD_UPDATE' || exetype eq 'EXTRACT' || exetype eq 'BROADCAST'  || exetype eq 'HOMECAST'}">
                            </c:when>
                            ...
                            <c:when test="${exetype eq 'UPDATE' || (exetype eq 'RECOVERY' && piiordersteptable.pagitypedetail eq 'RECOVERY_U')}">
                                <tr>
                                    ...
                                    <td class="td-get-l"><input type="text" class="form-control form-control-sm"
                                                                ...
                                                                onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"
                                                                name='parallelcnt'
                                                                value='<c:out value="${piiordersteptable.parallelcnt}"/>'>
                                    </td>
                                    ...
                                    <td class="td-get-l" rowspan=3>
                                        <div class="m-0 p-0">
                                            <table style="border: none; width:100%">
                                                ...
                                                <c:forEach items="${liststeptableupdate}" var="piiordersteptableupdate">
                                                    <tr style="border: none;">
                                                        <td style="border: none;"><c:out
                                                                value="${piiordersteptableupdate.column_name}"/> =
                                                        </td>
                                                        <td style="border: none;"><c:out
                                                                value="${piiordersteptableupdate.update_val}"/></td>
                                                    </tr>
                                                </c:forEach>
                            ...
                            <c:otherwise>
                                <tr>
                                    ...
                                    <c:if test="${exetype eq 'SCRAMBLE'}">
                                        <th class="th-get"><spring:message code="col.handlecnt" text="Data Processing Unit"/></th>
                                    </c:if>
                                    ...
                                    <td class="td-get-l" rowspan=3>
                                        <div class="m-0 p-0">
                                            <table style="border: none;">
                                                ...
                                                <c:forEach items="${liststeptablewait}" var="piiordersteptablewait">
                                                    <tr style="border: none;">
                                                        <td style="border: none;"><c:out
                                                                value="${piiordersteptablewait.table_name_w}"/></td>
                                                    </tr>
                                                </c:forEach>
                            ...
                            <c:when test="${exetype eq 'SCRAMBLE'  }">
                                <tr>
                                    ...
                                    <td class="td-get"
                                        ...
                                        <select class="form-control form-control-sm" name="succedding">
                                            <option value=""
                                    ...
                                    <th class="th-get"><spring:message code="etc.hashcol" text="Distribution Key"/><font
                                            style="color:RED">*</font></th>
                                    <td class="td-get-l" colspan=1><input type="text" class="form-control form-control-sm"
                                    ...
                                    <th class="th-get"><spring:message code="col.distributedtaskcnt" text="Distributed Task Cnt"/><font
                                            style="color:blue">*</font></th>
                                    <td class="td-get">
                                        <select class="form-control form-control-sm" name="pipeline">
                                            <option value=""
                                ...
                                <tr><th scope="row" class="th-get"><spring:message code="col.data_handling_method"
                                    ...
                                    <td class="td-get">
                                        <input type="text" class="form-control  form-control-sm small-text"
                                               ...
                                               value='<c:out value="${piiordersteptable.uval1}"/>'>
                                    </td>
                                    <th class="th-get"><spring:message code="col.index_unusual_flag" text="Index_Unusual_Flag"/><font
                                            style="color:blue">*</font></th>
                                    <td class="td-get">
                                        <select class="form-control form-control-sm" name="pagitypedetail">
                                            <option value=""
                                    ...
                                    <th class="th-hidden"><spring:message code="col.fk_disable_flag" text="Fk_Disable_Flag"/><font
                                            style="color:blue">*</font></th>
                                    <td class="td-hidden">
                                        <select class="form-control form-control-sm" name="pagitype">
                                            <option value=""
                                ...
                                <c:choose>
                                    ...
                                    <c:when test="${exetype eq 'MIGRATE' || exetype eq 'SYNC'}">
                                        ...
                                        <td class="td-get" COLSPAN="1">
                                            <select class="form-control form-control-sm" name="preceding">
                                                <option value=""
                                                        <c:if test="${piiordersteptable.preceding eq 'INSERT'}">selected</c:if> >
                                                </option>
                                                <option value="INSERT"
                        ...
                        <c:choose>
                            <c:when test="${exetype eq 'KEYMAP' }">
                                <tr>
                                    <th class="th-get"><spring:message code="etc.selectstr"
                                                                       text="Selectstr"/><br>(<spring:message
                                            code="etc.illustrative" text="Illustrative"/>)
                                    </th>
                                    <td class="td-get-l" colspan=5>
                                        <textarea spellcheck="false" rows="7" class="form-control form-control-sm"
                                                  name='wherestr' style="font-size: 12px;"><c:out
                            ...
                            <c:when test="${exetype eq 'ARCHIVE' }">
                                <tr>
                                    <th class="th-get"><spring:message code="etc.selectstr" text="Selectstr"/><font
                                            style="color:RED">*</font></th>
                                    <td class="td-get-l" colspan=5>
                                        <textarea spellcheck="false" rows="9" class="form-control form-control-sm"
                                                  name='wherestr' style="font-size: 12px;"><c:out
                                                value="${piiordersteptable.wherestr}"/></textarea>
                                    </td>
                                </tr>
                            ...
                            <c:when test="${exetype eq 'ILM' || exetype eq 'MIGRATE' || exetype eq 'SYNC'}">
                                <tr>
                                    ...
                                    <td class="td-get-l" colspan=5><textarea spellcheck="false" rows="14"
                                                                             class="form-control form-control-sm"
                                                                             name='wherestr'
                        ...
                        <c:choose>
                                <c:when test="${exetype eq 'DELETE' || exetype eq 'UPDATE' || exetype eq 'ARCHIVE'}"><tr>
                                    ...
                                    <td class="td-get-l" colspan=5>
                                        <textarea spellcheck="false" rows="8" class="form-control form-control-sm"
                                                  name='sqlstr' style="font-size: 12px;background-color: white;"
                                                  ><c:out value="${piiordersteptable.sqlstr}"/></textarea>
                                    </td></tr>
                                </c:when>
                                ...
                                <c:when test="${exetype eq 'BROADCAST'}"><tr>
                                    <th class="th-get"><spring:message code="col.sqlstr"
                                                                       text="Sqlstr"/><br>(<spring:message
                                            code="etc.illustrative" text="Illustrative"/>)
                                    </th>
                                    <td class="td-get-l" colspan=5>
                                        <textarea spellcheck="false" rows="12" class="form-control form-control-sm"
                                                  name='sqlstr' style="font-size: 12px;background-color: white;"
                                                  ><c:out value="${piiordersteptable.sqlstr}"/></textarea>
                                    </td></tr>
                                </c:when>
                                <c:when test="${exetype eq 'HOMECAST'}"><tr>
                                    <th class="th-get"><spring:message code="col.sqlstr"
                                                                       text="Sqlstr"/><br>(<spring:message
                                            code="etc.illustrative" text="Illustrative"/>)
                                    </th>
                                    <td class="td-get-l" colspan=5>
                                        <textarea spellcheck="false" rows="15" class="form-control form-control-sm"
                                                  name='sqlstr' style="font-size: 12px;background-color: white;"
                                                  ><c:out value="${piiordersteptable.sqlstr}"/></textarea>
                                    </td></tr>
                                </c:when>
                                <c:when test="${exetype eq 'EXTRACT'}"><tr>
                                    <th class="th-get"><spring:message code="col.sqlstr" text="Sqlstr"/><font
                                            style="color:RED">*</font></th>
                                    <td class="td-get-l" colspan=5>
                                        <textarea spellcheck="false" rows="21" class="form-control form-control-sm"
                                                  name='sqlstr' style="font-size: 12px;"><c:out
                    ...
                    <%--<input type="hidden" class="form-control form-control-sm" name='archiveflag'
                           value='<c:out value="${piiordersteptable.archiveflag}"/>'>
    ...
    <!-- The Modal end-->
    <!-- The Modal -->
    <div class="modal fade" id="dialogordertableupdatelist" role="dialog">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <!-- Modal body -->
                <div class="modal-body modal-body-custom" id="dialogordertableupdatelistbody">
                    <h6>Update column config</h6>
                </div>
                <!-- Modal footer -->
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary btn-sm p-0 pb-2 button"
                            id="dialogordertableupdatelistclose" data-dismiss="modal">Close
                    </button>
                </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#dialogsteptablewaitlistclose").on("click", function(e) {
            e.stopPropagation(); // 이벤트 버블링 중지
            $("#dialogsteptablewaitlist").modal("hide"); // 현재 모달만 닫기
        });

        $("button[data-oper='ordersteptablemodify']").on("click", function (e) {
    ...
    diologStepTableWaitAction = function () {
        ...
        var orderid = $('#piisteptable_modify_form [name=orderid]').val();
        ...
        url_view = "modifyordersteptablewaitdialog?orderid=" + orderid + "&" + "jobid=" + serchkeyno1 + "&" + "version=" + serchkeyno2 + "&" + "stepid=" + serchkeyno3
    ...
    diologStepTableUpdateAction = function () {
        ...
        var url_search = "";
        var url_view = "modifyordersteptableupdatedialog?"
            + "orderid=" + orderid + "&"
            + "jobid=" + jobid + "&"
            + "version=" + version + "&"
            + "stepid=" + stepid + "&"
        ...
        $.ajax({
            ...
            success: function (data) { ingHide();//alert('success1');
                $('#dialogordertableupdatelistbody').html(data);
